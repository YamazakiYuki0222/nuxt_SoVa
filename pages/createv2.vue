...
/*
*
const { data } = await useAsyncData<{ flyers: [TFlyer | undefined] }>(
  "getFlyer",
  async () => {
    let flyers = [];
...
*/
const updateFlyerList = (updatedData: [TFlyer]) => {
...
<template>
  <div id="content">
    <div class="create_content">
      ...
      <section>
        <button @click="createFlyer">作成</button>
      </section>
    </div>
